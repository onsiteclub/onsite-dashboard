...
```
       ...
       ▼               ▼               ▼               ▼               ▼
┌────────────┐  ┌────────────┐  ┌────────────┐  ┌────────────┐  ┌────────────┐
│  member    │  │   shop     │  │   learn    │  │   tech     │  │  website   │
...
| `member.onsiteclub.ca` | Member Area | Yes | No | Live |
...
| Member Area: user opens dashboard | `member.onsiteclub.ca/account` | Member Area middleware |
...
# Redirect security
ALLOWED_REDIRECT_DOMAINS=onsiteclub.ca,member.onsiteclub.ca,dashboard.onsiteclub.ca,shop.onsiteclub.ca,learn.onsiteclub.ca,tech.onsiteclub.ca

# URLs (for return redirects after payment)
NEXT_PUBLIC_DASHBOARD_URL=https://member.onsiteclub.ca
